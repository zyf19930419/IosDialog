...
import com.example.app.view.HintDialog;
import com.example.app.view.IOSLoadingDialog;
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_android_loading_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadingDialog.show(selfActivity.getSupportFragmentManager(), "loadingDialog");
            }
        });
        // 高仿IOS加载框
        findViewById(R.id.btn_ios_loading_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                iosLoadingDialog.show(selfActivity.getSupportFragmentManager(), "iosLoadingDialog");
            }
        });
        // 提示框
        findViewById(R.id.btn_ios_hint_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                hintDialog.show(selfActivity.getSupportFragmentManager(), "hintDialog");
            }
        });
        // 单个提示框
        findViewById(R.id.btn_ios_single_hint_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                singleHintDialog.show(selfActivity.getSupportFragmentManager(), "singleHintDialog");
            }
        });
        // 拍照 选取相册
        findViewById(R.id.btn_ios_camera_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                photoDialog.show(selfActivity.getSupportFragmentManager(), "");
            }
        });
    }
}
